...
import static org.exoplatform.platform.qa.ui.selenium.locator.answer.AnswerLocator.ELEMENT_COMMENT_DELETE_FORM_OK_BUTTON;
import static org.exoplatform.platform.qa.ui.selenium.locator.answer.AnswerLocator.ELEMENT_COMMENT_FORM_SAVE_BUTTON;
import static org.exoplatform.platform.qa.ui.selenium.locator.answer.AnswerLocator.ELEMENT_SUBMIT_QUESTION_FORM_SAVE_BUTTON;
...
@Tag("smoke")
@Tag("answer")
public class Addons_Answers_Comment extends Base{
    ...
    public  void test08_EditAComment() {
        ...
        $(ELEMENT_COMMENT_FORM_SAVE_BUTTON).click();
        $(byText(newcomment)).waitUntil(Condition.appears, Configuration.timeout);
