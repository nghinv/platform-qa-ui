...
public class ForumBookMarkTestIT extends Base {
    ...
    /*
     * Step Number: 1 Step Name: Prepare data: Create a category Step Description: -
     * Create a category Input Data: Expected Outcome: Category is created
     * successfully.
     */
    ...
    /*
     * Step number: 2 Step Name: Bookmark a category Step Description: - Right click
     * on a category, select Bookmark Input Data: Expected Outcome: - Bookmark
     * Category is successfully - BookmarkedCategory is displayed in Bookmark list
     */
    ...
    /*
     * Step Number: 1 Step Name: Prepare data: create a caterory, forum Step
     * Description: - Create a category - Create a forum Input Data: Expected
     * Outcome: Category, forum are created successfully
     */
    ...
    /*
     * Step number: 2 Step Name: Bookmark a forum Step Description: - Right click on
     * a forum, select Bookmark Input Data: Expected Outcome: - Bookmark forum is
     ...
     * Description: - Create a category - Create a forum in this category - Create a
     * topic in this forum Input Data: Expected Outcome: Category, forum, topic are
    ...
    /*
     * Step number: 2 Step Name: Bookmark a topic Step Description: - Right click on
     * a topic, select Bookmark Input Data: Expected Outcome: - Bookmark topic is
     * successfully - Bookmarkedtopic is displayed in Bookmark list
     */
        info("Bookmark the topic");
