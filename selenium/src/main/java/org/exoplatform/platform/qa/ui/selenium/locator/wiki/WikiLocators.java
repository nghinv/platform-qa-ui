...
public class WikiLocators {
  ...
  public static final By     ELEMENT_BLANK_PAGE_LINK                                    = By.xpath("//i[@class='uiIconAddPage']");

  public static final By     ELEMENT_WIKI_PAGE_TITLE_RENAME_FIELD                       = By.xpath(".//*[@id='EdiableInput']");
  ...
  public static final By     ELEMENT_SPACE_SWITCHET_EMPTY_LIST_SPACE                    = By.id("UISpaceSwitcher_nospace");
  ...
  public static final By     ELEMENT_WIKI_HOME_LEFTBOX_WIKIHOME                         = By.xpath("//*[text()=' Wiki Home']");

  // Confirm message
  public static final String ELEMENT_MESSAGES_TEXT                                      = "//*[contains(text(),'$mess')]";

  public static final By     ELEMENT_WARNING_OK_BTN                                     =
                                                    By.xpath(".//*[@class='btn'][text()='OK']");

  public static final By     ELEMENT_CONFIRM_POPUP_CONFIRM_BTN                          = By.xpath("//button[text()='Confirm']");

  public static final By     ELEMENT_CONFIRM_POPUP_CANCEL_BTN                           = By.xpath("//button[text()='Cancel']");

  public static final By     ELEMENT_CONFIRM_POPUP_OK_BTN                               = By.xpath("//button[text()='OK']");

  public static final By     ELEMENT_CONFIRM_POPUP_YES_BTN                              = By.xpath("//button[text()='Yes']");

  public static final By     ELEMENT_CONFIRM_POPUP_NO_BTN                               = By.xpath("//button[text()='No']");
  ...
  // Permalink page
  public static final By     ELEMENT_PERMALINK_LINKCOPY                                 = By.xpath("//*[@id='PermalinkText']");

  public static final By     ELEMENT_PERMALINK_MAKEPUBLIC                               = By.xpath("//*[text()='Make Public']");

  public static final By     ELEMENT_PERMALINK_RESTRICT                                 = By.xpath("//*[text()='Restrict']");
  ...
  // permission page
  public static final By     ELEMENT_PERMISSION_EDIT_ANY                                = By.xpath("//*[@id='EDITPAGEany']");
  ...
  public static final By     ELEMENT_PERMISSION_VIEW_ANY                                = By.xpath("//*[@id='VIEWPAGEany']");
  ...
  public static final By     ELEMENT_PAGE_PERMISSION_POPUP                              = By.id("UIWikiPagePermissionForm");
  ...
  public static final By     ELEMENT_MOVE_RENAMEWIKI                                    = By.xpath("//*[text()='Rename']");
  ...
  public static final By     ELEMENT_SEARCH_TEXTBOX                                     = By.xpath("//*[@id='wikiSearchValue']");
  ...
  // Permission
  public static final By     ELEMENT_PERMISSION_NAMEORGROUP                             = By.xpath("//*[@id='PermissionOwner']");
  ...
  public static final String ELEMENT_POPUP_MESSAGE_CONTENT                              = ".//*[contains(text(),'${message}')]";
  ...
  public static final String ELEMENT_PAGE_HISTORY_VERSION                               = ".//a[contains(text(),'$version')]";
  ...
  public static final By     ELEMENT_ADD_RELATED_POPUP_SELECT_BTN                       = By.xpath(".//button[text()='Select']");
  ...
  public static final By     ELEMENT_ADVANCED_SEARCH_FILTER                             = By.xpath(".//*[@id='wikis']//input");
  ...
  public static final By     ELEMENT_WIKI_SEARCH_FIELD                                  = By.xpath(".//*[@id='wikiSearchValue']");
  ...
  public static final By     ELEMENT_CANCEL_TEMPLATE                                    = By.id("UISubmitToolBarUpper_Cancel_");
  ...
  public static final By     ELEMENT_DRAFT_NO_BUTTON                                    = By.xpath("//*[contains(text(),'No')]");

  public static final String ELEMENT_DRAFT_TITLE                                        = "//*[contains(text(), '${title}')]";
  ...
  public static final String EMENENT_STATUS_LAYOUT                                      = "//th[contains(text(), '${title}')]";

  public static final String EMENENT_HOW_LAYOUT                                         = "//a[contains(text(), '${title}')]";
  ...
  public static final String ELEMENT_CHECK_IMAGE                                        = "//img[contains(@alt, '${file}')]";

  public static final String ELEMENT_CHECK_ATTACHED_FILE_LINK                           = ".//*[contains(@href,'$file')]";

  public static final String ELEMETN_WIKI_STATUS_VERSION_TEXT                           = ".//*[contains(text(),'$status')]";
  ...
  // Macro
  public static final By     ELEMENT_MACRO_LINK                                         = By.xpath("//*[text()='Macro']");
  ...
  public static final By     ELEMENT_MACRO_RSS_TITLE                                    = By.xpath("//p[@class='rssitemtitle']");
  ...
  public static final By     ELEMENT_WIKI_PAGE_LINK_MENU                                = By.xpath("//*[text()='Wiki Page...']");

  public static final By     ELEMENT_WEB_PAGE_LINK_MENU                                 = By.xpath("//*[text()='Web Page...']");

  public static final By     ELEMENT_ATTACHED_FILE_LINK_MENU                            =
                                                             By.xpath("//*[text()='Attached File...']");

  public static final By     ELEMENT_REMOVE_LINK_MENU                                   = By.xpath("//*[text()='Remove Link']");

  public static final By     ELEMENT_EMAIL_LINK_MENU                                    =
                                                     By.xpath("//*[text()='Email Address...']");

  public static final By     ELEMENT_EDIT_LINK_MENU                                     = By.xpath("//*[text()='Edit Link...']");

  // Image menu
  public static final By     ELEMENT_IMAGE_LINK                                         = By.xpath("//*[text()='Image']");
  ...
  public static final By     ELEMENT_EDIT_IMAGE_LINK_MENU                               = By.xpath("//*[text()='Edit Image...']");

  public static final By     ELEMENT_REMOVE_IMAGE_LINK_MENU                             = By.xpath("//*[text()='Remove Image']");

  public static final By     ELEMENT_IMAGE_MENU_INSERT_IMAGE_BTN                        = By.xpath("//*[text()='Insert Image']");

  public static final By     ELEMENT_IMAGE_MENU_IMAGE_SETTINGS_BTN                      =
                                                                   By.xpath("//*[text()='Image Settings']");

  // Image link popup
  public static final String ELEMENT_IMAGE_LINK_IMAGE_THUMBNAIL                         = "//*[contains(@title,'$image')]";
  ...
  public static final By     ELEMENT_IMAGE_ALIGN_LEFT                                   = By.xpath(".//*[@value='LEFT']");

  public static final By     ELEMENT_IMAGE_ALIGN_CENTER                                 = By.xpath(".//*[@value='CENTER']");

  public static final By     ELEMENT_IMAGE_ALIGN_RIGHT                                  = By.xpath(".//*[@value='RIGHT']");

  public static final By     ELEMENT_IMAGE_ALIGN_TOP                                    = By.xpath(".//*[@value='TOP']");

  public static final By     ELEMENT_IMAGE_ALIGN_MIDDLE                                 = By.xpath(".//*[@value='MIDDLE']");

  public static final By     ELEMENT_IMAGE_ALIGN_BOTTOM                                 = By.xpath(".//*[@value='BOTTOM']");
  ...
  public static final By     ELEMENT_SEARCH_BUTTON                                      = By.xpath("//button[text()='Search']");
  ...
  public static final By     ELEMENT_SELECT_BUTTON                                      = By.xpath("//*[text()='Select']");

  public static final By     ELEMENT_CREATE_LINK_BUTTON                                 = By.xpath("//*[text()='Create Link']");
  ...
  public static final By     ELEMENT_REMOVE_LINK                                        = By.xpath("//div[text()='Remove Link']");
  ...
  public static final String ELEMENT_CURRENT_TAB_ATTACHED_FILE_SELECTED                 = "//*[contains(text(),'$file')]";
  ...
  // Table
  public static final By     ELEMENT_TABLE_LINK                                         = By.xpath("//*[text()='Table']");

  public static final By     ELEMENT_INSERT_TABLE_LINK                                  =
                                                       By.xpath("//*[text()='Insert Table...']");

  public static final By     ELEMENT_ROW_TEXTBOX                                        = By.xpath("//*[@title='Row count']");

  public static final By     ELEMENT_COLUMN_TEXTBOX                                     = By.xpath("//*[@title='Column count']");
  ...
  public static final By     ELEMENT_MACRO_RSS_IN_CONTENT_PAGE                          = By.xpath("//div[@class='box rssfeed']");

  public static final By     ELEMENT_CREATE_MACRO_BUTTON                                =
                                                         By.xpath("//button[text()='Insert Macro']");

  public static final String ELEMENT_MACRO_CLASS_INSERT_INTO_FRAME                      = ".//*[contains(@class,'$macro')]";
  ...
  // *=============================================================SOURCE
  // EDITOR==========================================================*\\
  public static final String ELEMENT_EFFECT_BOLD                                        = "//strong[contains(text(),'$content')]";

  public static final String ELEMENT_EFFECT_BULLET_LIST                                 = "//ul/li[contains(text(),'$content')]";

  public static final String ELEMENT_EFFECT_NUMBER_LIST                                 = "//ol/li[contains(text(),'$content')]";

  public static final String ELEMENT_EFFECT_HEADING_1                                   = "//h1//*[contains(text(),'$content')]";

  public static final String ELEMENT_EFFECT_HEADING_3                                   = "//h3//*[contains(text(),'$content')]";

  public static final String ELEMENT_EFFECT_HEADING_2                                   = "//h2//*[contains(text(),'$content')]";

  public static final String ELEMENT_EFFECT_HEADING_5                                   = "//h5//*[contains(text(),'$content')]";

  public static final String ELEMENT_EFFECT_ITALIC                                      = "//em[contains(text(),'$content')]";

  public static final String ELEMENT_EFFECT_LINK                                        = "//*[contains(@href,'$content')]";

  public static final String ELEMENT_EFFECT_STRIKE                                      = "//del[contains(text(),'$content')]";

  public static final String ELEMENT_EFFECT_UNDERLINE                                   = "//ins[contains(text(),'$content')]";
  ...
  public static final By     ELEMENT_PERMISSION_SELECT_MEMBERSHIP                       = By.className("uiIconMembership");
  ...
  public static final String ELEMENT_WIKI_SETTINGS_PERMISSION_SELECT_SEARCH_OPTION      = "//*[contains(@name,'filter')]";
