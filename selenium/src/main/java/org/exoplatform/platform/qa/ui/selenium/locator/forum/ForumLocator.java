...
public class ForumLocator {
  ...
  public static final By     ELEMENT_FORUM_TOPIC_UNLOCK                         = By.xpath("//*[@class='uiIconUnlockMedium']");
  ...
  public static final String ELEMENT_FORUM_NAVIGATION_BREADCRUMB                = "//*[@class='breadcrumb']//*[text()='${name}']";
  ...
  public static final By     ELEMENT_FORUM_WHAT_GOING_ON                        = By.xpath("//div[contains(text(),'Going on?')]");
  ...
  public static final By     ELEMENT_FORUM_SETTINGS_FORUMSETTINGS               = By.xpath("//*[text()='Forum Settings']");

  public static final By     ELEMENT_FORUM_SETTINGS_MYSUSCRIB                   = By.xpath("//*[text()='My Subscriptions']");

  public static final By     ELEMENT_FORUM_SETTINGS_SCREENNAME                  = By.xpath("//*[@id='ScreenName']");

  public static final By     ELEMENT_FORUM_SETTINGS_MAXTHREADS                  = By.xpath("//*[@name='MaximumThreads']");
  ...
  public static final String ELEMENT_SEARCH_FORUM_POST                          = "//*[text()='Post']/../..//*[text()='${name}']";
  ...
  public static final By     ELEMENT_SEARCH_FORUM_ADVANCEDSEARCH                = By.xpath("//*[text()='Advanced Search']");
  ...
  public static final By     ELEMENT_EDIT_FORUM                                 = By.xpath("//*[contains(@href, 'EditForum')]");

  public static final By     ELEMENT_DELETE_FORUM                               =
                                                  By.xpath("//*[contains(@data-action, 'RemoveForum')]");

  public static final By     ELEMENT_MOVE_FORUM                                 = By.xpath("//*[contains(@href, 'MoveForum')]");

  public static final By     ELEMENT_START_TOPIC_BUTTON                         = By.xpath("//*[contains(@href, 'AddTopic')]");
  ...
  public static final By     ELEMENT_OPEN_FORUM                                 = By.xpath("//a[contains(@href,'SetOpenForum')]");
